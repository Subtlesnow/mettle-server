...
exports.up = function(knex, Promise) {
  return knex.schema.createTable('planet_resource', function(planet_resource) {
    ...
    planet_resource.integer('planet_id').notNullable().references('planet.id').onDelete('cascade');
    planet_resource.integer('resource_id').notNullable().references('resource.id').onDelete('cascade');
